...
public class EmailAuthActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_auth_activity);
    ...
    private void gotoProfile(){
        Intent intent = new Intent(EmailAuthActivity.this, EmailProfileDisplay.class);
